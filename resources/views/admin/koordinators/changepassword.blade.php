                ...
                <div class="layout-specing">
                    ...
                    <div class="row">
                        <div class="col-6 mt-4">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="/admins/koordinators/changepassword"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input name="user_id" type="number" hidden value={{ $id }} />
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <label class="form-label">Password Baru<span
                                                        class="text-danger">*</span></label>
                                                <input name="new_password" id="name" type="text" required
